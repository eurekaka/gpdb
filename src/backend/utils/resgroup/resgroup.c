...
ResGroupControlInit(void)
{
    ...
    LOG_RESGROUP_DEBUG(NOTICE, "Creating hash table for %d resource groups", MaxResourceGroups);
...
InitResGroups(void)
{
	...
	LOG_RESGROUP_DEBUG(NOTICE, "initialized %d resource groups", numGroups);
