...
%type <node>	stmt schema_stmt
		...
		DropGroupStmt DropOpClassStmt DropOpFamilyStmt DropPLangStmt DropQueueStmt DropResGroupStmt DropStmt
...
DropResGroupStmt:
			DROP RESOURCE GROUP_P QueueId
				 {
					DropResGroupStmt *n = makeNode(DropResGroupStmt);
					n->resgroup = $4;
					$$ = (Node *)n;
				 }
		;
